...
#define GC9503_CMD_MADCTL (0xB1)

#define GC9503_CMD_MADCTL_DEFAULT (0x10)

#define GC9503_CMD_SS_BIT (1 << 0)

#define GC9503_CMD_GS_BIT (1 << 1)

#define GC9503_CMD_BGR_BIT (1 << 5)
