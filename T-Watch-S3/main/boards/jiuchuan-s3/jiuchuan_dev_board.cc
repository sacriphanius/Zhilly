...
public:
    ...
    virtual void SetupUI() override {
        ...
        lv_obj_set_style_pad_left(top_bar_, LV_HOR_RES * 0.12, 0);

        lv_obj_set_style_pad_right(top_bar_, LV_HOR_RES * 0.12, 0);

        lv_obj_align(emoji_box_, LV_ALIGN_CENTER, 0, -30);
    ...
    void InitializePowerSaveTimer() {
        ...
        if (cause == ESP_SLEEP_WAKEUP_EXT0) {
            ...
            if (long_press_occurred) {
                ...
                ESP_ERROR_CHECK(rtc_gpio_pullup_en(PWR_BUTTON_GPIO));
