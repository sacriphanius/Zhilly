...
NoAudioCodecSimplex::NoAudioCodecSimplex(int input_sample_rate, int output_sample_rate,
                                         ...
                                         gpio_num_t spk_dout, gpio_num_t mic_sck, gpio_num_t mic_ws,
                                         gpio_num_t mic_din) {
    duplex_ = false;
    input_sample_rate_ = input_sample_rate;
    output_sample_rate_ = output_sample_rate;
...
int NoAudioCodec::Write(const int16_t* data, int samples) {
    ...
    // volume_factor_: 0-131072 (2x boost)
    int32_t volume_factor = pow(double(output_volume_) / 100.0, 2) * 131072;
